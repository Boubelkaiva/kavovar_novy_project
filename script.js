...
window.addEventListener("DOMContentLoaded", () => {
  ...
  buttons.forEach((button) => {
    button.addEventListener("click", (event) => {
      ...
      if (selectedKava) {
        ...
        // Zobrazení políček pro zadání PIN
        const keyboardPin = document.querySelector("#keyboardPin");
        keyboardPin.style.display = "block";
  ...
  buttonOK.addEventListener("click", (event) => {
    ...
    audio.addEventListener("ended", () => {
      ...
      const textClickChangeEnd = document.querySelector(".payment-dis h3");
      textClickChangeEnd.textContent = "Vyberte kávu";
